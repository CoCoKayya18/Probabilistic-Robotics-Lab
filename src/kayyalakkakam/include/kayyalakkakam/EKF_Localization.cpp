...
geometry_msgs::PoseStamped EKF_Localization::publishEKFPose()
{
...
nav_msgs::Path EKF_Localization::publishEKFPath() 
{
...
nav_msgs::Path EKF_Localization::publishOdometryPath() 
{
    static nav_msgs::Path path;
    path.header.stamp = ros::Time::now();
    path.header.frame_id = "map"; // Or whatever your fixed frame is
...
visualization_msgs::Marker EKF_Localization::publishCovariance() 
{
...
visualization_msgs::Marker EKF_Localization::publishCornerFeatures()
{
...
void EKF_Localization::prediction_step(nav_msgs::Odometry odomMsg)
{
...
void EKF_Localization::correction_step(sensor_msgs::LaserScan laserscanMsg)
{   
    this->laserscanMessage = laserscanMsg;
